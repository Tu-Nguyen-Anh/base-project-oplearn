...
```env
# Endpoint backend dùng để upload/delete file
# Nếu đã public domain → dùng domain luôn (khuyến nghị)
RUSTFS_ENDPOINT=https://rustfs.olhub.org

# Credentials — lấy từ RustFS console
...
# URL ảnh sẽ có dạng: https://rustfs.olhub.org/news/feedbacks/uuid.jpg
RUSTFS_PUBLIC_URL=https://rustfs.olhub.org
```

### Tạo bucket trong RustFS console

1. Mở RustFS console (port 9009 nội bộ hoặc qua domain admin)
2. Đăng nhập bằng access key / secret key
3. Tạo bucket tên `news`
